...
phrase lng_wallet_cover_balance_test = "Ваш тестовый баланс";
phrase lng_wallet_cover_locked = "заблокирован";
...
phrase lng_wallet_row_init = "Инициализация кошелька";
phrase lng_wallet_row_service = "Пустая транзакция";
...
phrase lng_wallet_receive_description = "Поделитесь этой ссылкой с другими держателями кошельков, чтобы получить Gram от них.";
phrase lng_wallet_receive_description_test = "Поделитесь этой ссылкой, чтобы получить тестовые Gram. Важно: эта ссылка не будет работать для настоящих токенов.";
phrase lng_wallet_receive_create_invoice = "Выставить счёт";
phrase lng_wallet_receive_share = "Поделиться адресом кошелька";
phrase lng_wallet_receive_copied = "Ссылка скопирована в буфер.";
phrase lng_wallet_receive_address_copied = "Адрес скопирован в буфер.";
...
phrase lng_wallet_invoice_url_about = "Поделитесь этой ссылкой с другими держателями кошельков, чтобы получить Gram от них.";
phrase lng_wallet_invoice_url_about_test = "Поделитесь этой ссылкой, чтобы получить тестовые Gram. Важно: эта ссылка не будет работать для настоящих токенов.";
...
phrase lng_wallet_menu_delete = "Отключиться от кошелька";

phrase lng_wallet_delete_title = "Отключиться от кошелька";
...
phrase lng_wallet_settings_mainnet = "Основная сеть";
phrase lng_wallet_settings_testnet = "Тестовая сеть";
phrase lng_wallet_settings_blockchain_name = "ID блокчейна";

phrase lng_wallet_warning_reconnect = "Если вы продолжите, вам нужно будет переподключить кошелёк используя 24 секретных слова.";
...
phrase lng_wallet_warning_to_testnet = "Вы точно хотите переключиться на тестовую сеть Gram? Она существует только для тестовых целей.";
phrase lng_wallet_warning_to_mainnet = "Вы точно хотите переключиться на основную сеть Gram? Токены в ней имеют реальную ценность.";
